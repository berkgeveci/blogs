...
look at the [header](examples/vtkConstantArray.h)  and the [implementation](examples/vtkConstantArray.txx).
...
at a data array that can used to develop such a filter. See [here](examples/vtkImagePointsArray.h)
and [here](examples/vtkImagePointsArray.txx) for the implementation.
...
The full code which can be found [here](examples/imageugrid.cxx)
