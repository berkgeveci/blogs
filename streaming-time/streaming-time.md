...
[[1](../pipeline/pipeline.md)], [[2](../pipeline-2/pipeline-2.md)]
and [[3](../pipeline-3/pipeline-3.md)].
...
![Stoke's plate](images/flow-over-plate.png)
...
<figure>
<img src="images/profile0.png" alt="Animation" style="margin-left:auto; margin-right:auto" onclick='javascript:this.src="images/profile.gif"'/>
</figure>

The code I used to generate this animation is [here](examples/plot.py).
...
![velocity over time](images/u_over_time.png)
