...
In my last two blogs ([1](../vtk-python-algorithm/vtk-python-algorithm.md),
[2](../h5py-reader/h5py-reader.md)), I introduced the `vtkPythonAlgorithm`
...
<img src="images/example-pipeline.png" alt="example pipeline" style="width: 600px; margin-left:auto; margin-right: auto"/>
