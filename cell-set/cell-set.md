...
In the last 2 blogs ([1](../zero-copy-arrays/zero-copy-arrays.md),
[2](../zero-copy-sync-templates/zero-copy-sync-templates.md)), we have looked at creating
...
[a previous blog](../zero-copy-arrays/zero-copy-arrays.md). The full source for
this array is [here](examples/vtkImagePointsArray.h)
and [here](examples/vtkImagePointsArray.txx). In summary, `vtkImagePointsArray` is a sub-class of
...
[here](examples/vtkCellSet.h)
and [here](examples/vtkCellSet.cxx)
