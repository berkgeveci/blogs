...
In a [previous blog](../pipeline/pipeline.md), I covered some of the
...
![a pipeline](images/empty-pipeline.png)
...
[this blog](../h5py-reader/h5py-reader.md) for example), timesteps
...
[this blog](../h5py-reader/h5py-reader.md) for details. Our pipeline
looks like this:

![hdf5 pipeline](images/hdf5-pipeline.png)
