...
In previous blogs ([1](../pipeline/pipeline.md),
[2](../pipeline-2/pipeline-2.md)), I started discussing how the VTK
...
![meta-data2](images/meta-data2.png)
...
can find the full example [on this page](examples/pipeline.py). I also recommend taking a
look at [this blog](../h5py-reader/h5py-reader.md) as it demonstrates how these concepts are used in developing
an HDF5 reader.