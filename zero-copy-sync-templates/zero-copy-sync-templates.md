...
In my [last blog](../zero-copy-arrays/zero-copy-arrays.md), I demonstrated
...
The full code can be found [here](examples/vtkGridSynchronizedTemplates3D2.cxx). The change is minimal. I first made
